    ...
    <aside className="w-64 flex flex-col">
      ...
      <div className="h-16 flex items-center px-6 border-b">
        <Link href="/dashboard" className="flex items-center gap-3">
          ...
          <span className="font-semibold">WhatsFlow</span>
        </Link>
      </div>
      ...
      <div className="px-4 py-3 border-b">
        <div className="flex items-center gap-3 px-2 py-2 rounded-lg">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center font-semibold text-sm">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs capitalize">{tenant.plan} plan</p>
          </div>
        </div>
      </div>
